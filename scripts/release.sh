...
#   New tag creation → "To github.com:TakanariShimbo/ros2-exec-mcp.git * [new tag] v0.1.4 -> v0.1.4"
...
#   新しいタグ作成 → "To github.com:TakanariShimbo/ros2-exec-mcp.git * [new tag] v0.1.4 -> v0.1.4"
...
#   "The GitHub workflow will now build and publish the package to pypi"
#   "Check the Actions tab in your GitHub repository for progress"
#   User should visit: https://github.com/TakanariShimbo/ros2-exec-mcp/actions
#   Package will be available at: https://pypi.org/project/takanarishimbo-ros2-exec-mcp/
#
# 11. 成功メッセージ
#
# 完了メッセージと次のステップを表示
...
#   "GitHubワークフローがパッケージをビルドしてpypiに公開します"
#   "進捗状況はGitHubリポジトリのActionsタブで確認してください"
#   ユーザーが訪問すべき場所: https://github.com/TakanariShimbo/ros2-exec-mcp/actions
#   パッケージの公開場所: https://pypi.org/project/takanarishimbo-ros2-exec-mcp/
# =====================
